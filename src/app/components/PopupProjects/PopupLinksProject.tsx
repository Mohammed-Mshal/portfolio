...
export default function PopupLinksProject(
    {
        link,
        nameLink,
        projectName,
                            ...
                            {typeButton === 'Add' || typeButton === 'Edit' ?
                                <>
                                    <div className="form-group flex flex-col gap-4">
                                        <label htmlFor="nameLink" className='lg:text-2xl text-lg text-start'>
                                            Title Link
                                        </label>
                                        <input type="text" defaultValue={nameLink} name="nameLink" id="nameLink" className='rounded-lg border border-white/40 p-2 px-4 outline-none' />
                                    </div>
                                    <div className="form-group flex flex-col gap-4">
                                        <label htmlFor="imageLink" className='lg:text-2xl text-lg text-start'>
                                            Image Link
                                        </label>
                                        <input type="file" name="imageLink" id="imageLink" className='rounded-lg border border-white/40  p-2 px-4 outline-none cursor-pointer' />
                                    </div>
                                    <div className="form-group flex flex-col gap-4">
                                        <label htmlFor="link" className='lg:text-2xl text-lg text-start'>
                                            Link
                                        </label>
                                        <input type="url" defaultValue={link} name="link" id="link" className='rounded-lg border border-white/40 p-2 px-4 outline-none' />
                                    </div>
                                    {listProject &&
                                        <div className="form-group flex flex-col gap-4">
